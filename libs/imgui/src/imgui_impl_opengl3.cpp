...
bool ImGui_ImplOpenGL3_Init(const char *glsl_version)
{
        ...
        // auto-detection fails or doesn't select the same GL loader file as used by
        // your application, you are likely to get a crash below. You can explicitly
        // select a loader by using '#define IMGUI_IMPL_OPENGL_LOADER_XXX' in
...
void ImGui_ImplOpenGL3_RenderDrawData(ImDrawData *draw_data)
{
        ...
        ImVec2 clip_scale = draw_data->FramebufferScale; // (1,1) unless using retina

...
typedef int
ImGuiLayoutType;          // -> enum ImGuiLayoutType_         // Enum:
// Horizontal or vertical
typedef int
ImGuiItemFlags;           // -> enum ImGuiItemFlags_          // Flags: for
// PushItemFlag()
typedef int
ImGuiItemStatusFlags;     // -> enum ImGuiItemStatusFlags_    // Flags:
// for DC.LastItemStatusFlags
typedef int
ImGuiOldColumnFlags;      // -> enum ImGuiOldColumnFlags_     // Flags:
// for BeginColumns()
...
typedef int
ImGuiNavMoveFlags;        // -> enum ImGuiNavMoveFlags_       // Flags: for
// navigation requests
...
typedef int
ImGuiSeparatorFlags;      // -> enum ImGuiSeparatorFlags_     // Flags:
// for SeparatorEx()
typedef int
...
struct ImGuiTable {
        ...
        ImGuiWindow
        *InnerWindow;         // Window holding the table data (== OuterWindow
        // or a child window)
...
SetNextWindowScroll(const ImVec2
                    &scroll); // Use -1.0f on one axis to leave as-is
...
IMGUI_API int CalcTypematicRepeatAmount(float t0, float t1, float repeat_delay,
                                        float repeat_rate);
IMGUI_API void
ActivateItem(ImGuiID
             id); // Remotely activate a button, checkbox, tree node etc. given
...
IMGUI_API bool ButtonEx(const char *label, const ImVec2 &size_arg = ImVec2(0,
                        0),
...
IMGUI_API void ImFontAtlasBuildMultiplyCalcLookupTable(unsigned char
                out_table[256],
                float in_multiply_factor);
IMGUI_API void ImFontAtlasBuildMultiplyRectAlpha8(const unsigned char
                table[256],
